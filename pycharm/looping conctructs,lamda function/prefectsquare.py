# (d) Generate a list of four-digit numbers in a given range 
#     with all their digits even and the number is a perfect square.

start_range = int(input("\nEnter the starting range (4 digit min): "))
